...
const cdtime = 5;
const prefix = "b!"
client.login("ODU0MzgxOTM1NTU0NzIzOTAw.YMjHLw.oeNFaz13AUZBcqHQ82dPrUk_lWs")
client.on("ready", () => {
...
const channel = member.guild.channels.cache.find(channel => channel.id === wlcblack[member.guild.id].channel);
let embed = new Discord.MessageEmbed()
.setColor('RANDOM')
...
client.on ("guildMemberAdd", async (black) => {
   ...
   var channel = client.guild.channels.cache.find(r => r.name === wlcblack[black.guild.id].channel);
        ...
        const background = await Canvas.loadImage("https://media.discordapp.net/attachments/804296740941201438/804750409687892058/20201105_210858.png");
...
client.on('message', message => {
            if(message.content.startsWith(prefix + "toggleWelcome on")) {
                if(!message.channel.guild) return;
...
client.on('message', message => {
            if(message.content.startsWith(prefix + "toggleWelcome off")) {
                if(!message.channel.guild) return;
                if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**Sorry But You Dont Have Permission** `MANAGE_GUILD`' );
        wlcblack[message.guild.id] = {
        onoff: 'Off',
       ...
       let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle Welcome is Off**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${wlcblack[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
...
client.on('message', message => {
  if(message.content.startsWith(prefix + "infoWelcome")) {
...
let embed = new Discord.MessageEmbed()
.addField('Channel Status', `${wlcblack[message.guild.id].onoff}`,)
.addField('Channel', `${wlcblack[message.guild.id].channel}`)
...
client.on('message', message => {
       ...
       let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle sug is On**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${sug[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
                      .setFooter(`${client.user.username}`)                  
                     message.channel.send(embed)       
...
client.on('message', message => {
       ...
       let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle sug is Off**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${sug[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
...
client.on('message', message => {
  if(message.content.startsWith(prefix + "infoSug")) {
    if (!message.guild.member(message.author).hasPermission("ADMINISTRATOR")) return message.reply("Sorry You Not Have Premission Administrator")
let embed = new Discord.MessageEmbed()
...
client.on('guildMemberAdd', member => {
  member.guild.fetchInvites().then(guildInvites => {
    ...
    const L = member.guild.channels.cache.find(black => black.name === invite[member.guild.id].channel);
     L.send(`<@${member.user.id}> Invited by <@${inviter.id}>`);
  });
});
...
client.on("guildMemberRemove", async member => {
    if (!left[member.guild.id])
      left[member.guild.id] = {
        onoff: "Off"
      };
    if (left[member.guild.id].onoff === "Off") return;
...
client.on('message', message => {
  if(message.content.startsWith(prefix + "infoLeave")) {
    if (!message.guild.member(message.author).hasPermission("ADMINISTRATOR")) return message.reply("Sorry You Not Have Premission Administrator")
let embed = new Discord.MessageEmbed() 
...
client.on('message', message => {
    if(message.content.startsWith(prefix + "toggleLeave on")) {
        if(!message.channel.guild) return;
        if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**Sorry But You Dont Have Permission** `MANAGE_GUILD`' );
left[message.guild.id] = {
onoff: 'On',
...
let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle Left is On**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${setxp[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
                      .setFooter(`${client.user.username}`)                  
                     message.channel.send(embed)      
...
client.on('message', message => {
    if(message.content.startsWith(prefix + "toggleLeave off")) {
        if(!message.channel.guild) return;
        if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**Sorry But You Dont Have Permission** `MANAGE_GUILD`' );
left[message.guild.id] = {
onoff: 'Off',
     ...
     let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle Left is Off**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${left[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
                      .setFooter(`${client.user.username}`)                  
                     message.channel.send(embed)
...
client.on('message', message => {
  ...
  if (!setxp[message.guild.id])
      setxp[message.guild.id] = {
        onoff: "Off"
      };
    if (setxp[message.guild.id].onoff === "Off") return;
 ...
 saveBlackJack()
    ...
    if(nextLvL <= xp[message.author.id].xp){
     ...
     channel.send(`<@${message.author.id}>  Level Up, Your Are Level Now ${curlvl} 🥳`)
    }  
 saveBlackJack()
});
client.on('message', message => {
...
client.on('message', message => {
    if(message.content.startsWith(prefix + "toggleLevel on")) {
        if(!message.channel.guild) return;
        if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**Sorry But You Dont Have Permission** `MANAGE_GUILD`' );
setxp[message.guild.id] = {
onoff: 'On',
...
let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle Level is On**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${setxp[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
...
client.on('message', message => {
    if(message.content.startsWith(prefix + "toggleLevel off")) {
        if(!message.channel.guild) return;
        if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**Sorry But You Dont Have Permission** `MANAGE_GUILD`' );
setxp[message.guild.id] = {
onoff: 'Off',
     ...
     let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle Level is Off**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${setxp[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
...
client.on('message', async message => {
   ...
   if(message.content.startsWith(prefix + "setReponse1")) {
    ...
    message.channel.send('Now Send First Message').then(msg => {
        ...
        .then(collected => {
            ...
            let boi;
            msg.edit('Now send Last message').then(msg => {
...
client.on('message', async message => {
   ...
   if(message.content === reply2[message.guild.id].msg) {
       message.reply(reply2[message.guild.id].reply)
   }}
)
...
let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle Reponse is On**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${reply[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
                      .setFooter(`${client.user.username}`)                  
                     message.channel.send(embed)      
...
let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle Reponse is Off**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${reply[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
...
let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle Reponse is On**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${reply2[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
                      .setFooter(`${client.user.username}`)                  
                     message.channel.send(embed)
...
client.on('message', message => {
  if(message.content.startsWith(prefix + "infoAutoReponse1")) {
    if (!message.guild.member(message.author).hasPermission("ADMINISTRATOR")) return message.reply("Sorry You Not Have Premission Administrator")
let embed = new Discord.MessageEmbed()
.addField('Message Status', `${reply[message.guild.id].onoff}`,)
...
client.on('message', async message => {
    let messageArray = message.content.split(" ");
   if(message.content.startsWith("b!setReponse3")) {
...
client.on('message', message => {
  if(message.content.startsWith(prefix + "infoAutoReponse3")) {
    if (!message.guild.member(message.author).hasPermission("ADMINISTRATOR")) return message.reply("Sorry You Not Have Premission Administrator")
let embed = new Discord.MessageEmbed()
.addField('Message Status', `${reply3[message.guild.id].onoff}`,)
...
client.on("message", message => {
  ...
  const role = rWlc[message.guild.id].role;
...
.setAuthor(message.author.username,message.author.avatarURL())
.setThumbnail(message.author.avatarURL())
.setTitle('**✅Done Check The AutoRole Code Has Been Setup**')
...
saveBJ()
        ...
        client.on('message', message => {
            if(message.content.startsWith(prefix + "toggleArole on")) {
                if(!message.channel.guild) return;
                if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**Sorry But You Dont Have Permission** `MANAGE_GUILD`' );
        rWlc[message.guild.id] = {
        onoff: 'On',
        ...
        saveBJ()
       let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle AutoRole is On**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${setxp[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
...
client.on('message', message => {
            if(message.content.startsWith(prefix + "toggleArole off")) {
                if(!message.channel.guild) return;
                if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('**Sorry But You Dont Have Permission** `MANAGE_GUILD`' );
        rWlc[message.guild.id] = {
        onoff: 'Off',
        ...
        saveBJ()
       let embed = new Discord.MessageEmbed()
                      .setTitle('**✅Done Check The Toggle AutoRole is Off**')
                      .addField('Name Server', message.guild.name)
                      .addField('Toggle', `${setxp[message.guild.id].onoff}`)
                      .addField('By', `${message.author.username}`)
                      .setThumbnail(message.author.avatarURL())
...
client.on("guildMemberAdd", member => {
    ...
    if (rWlc[member.guild.id].onoff === "Off") return;
  if (!rWlc[member.guild.id])
    rWlc[member.guild.id] = {
      role: sRole
    };
...
client.on('message', message => {
  if(message.content.startsWith(prefix + "infoAutoRole")) {
  if (!message.guild.member(message.author).hasPermission("ADMINISTRATOR")) return message.reply("Sorry You Not Have Premission Administrator")
let embed = new Discord.MessageEmbed()
.addField('Role Status', `${rWlc[message.guild.id].onoff}`)
.addField('Role Setup', `${rWlc[message.guild.id].role}`)
.addField('Requested By', `${message.author}`)
.setThumbnail(message.author.avatarURL())
.setFooter(`${client.user.username}`)
message.channel.send(embed)
        ...
        member.guild.members.cache
          ...
          .catch(e =>
            member.guild.owner.send(
              `** | ${entry.username} Tryed To \`Ban\` Many \`Members\` in A server ${member.guild.name}.**`
            )
          );
        anti[member.guild.id + entry.id].actions = "0";
